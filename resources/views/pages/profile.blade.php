...
<style>
    ...
    */
    ...
    .cssui-usercard__header{
        ...
        display: flex;
        align-items: center;
        background-image: linear-gradient(to bottom, #b01ba5,#041886, #b01ba5);
        color: white;
    }
    ...
    .cssui-usercard__footer{
        ...
        background: linear-gradient(40deg, rgba(55,0,255,1) 32%, rgba(206,39,231,1) 42%);
        color:  rgb(0,117,255);;
    }
    ...
    <div class="cssui-usercard__body">
        <header class="cssui-usercard__header">
            ...
            <div class="cssui-usercard__header-info">
                ...
                <span class="cssui-usercard__post">Free-Fire player</span>
            </div>
        </header>
